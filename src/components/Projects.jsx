...
export const Projects = () => {
  return (
    <main className='pt-20 md:px-6'>
      <h1 className="font-montserrat text-5xl font-bold text-whiteCream text-center">PROYECTOS</h1>
      <p className='text-center font-robotoMono mt-2 text-xs md:text-sm'>
