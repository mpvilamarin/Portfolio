...
export const metadata = {
  ...
  description:
    'Soy Paula Villamarín, desarrolladora frontend y diseñadora gráfica. Combino código y creatividad para crear interfaces accesibles, interactivas y funcionales.',
};
      ...
      <section className="relative min-h-screen flex flex-col justify-center overflow-hidden
        ...
        <FadeIn delay={0.05}>
          <p className="font-mono text-[11px] text-muted tracking-[5px] mb-8 lg:mb-10">
            <span className="text-accent">// </span>portfolio.v2
          </p>
        </FadeIn>
          ...
          <FadeIn delay={0.3}>
            <div className="flex items-center gap-4 mt-6 lg:mt-8">
              ...
              <p className="font-mono text-[10px] sm:text-xs text-muted tracking-[3px] uppercase">
                Frontend Developer<span className="text-accent mx-2">·</span>Graphic Designer
              </p>
            </div>
          </FadeIn>
