      ...
      <section className="relative z-10 flex-1 flex flex-col justify-center">
        ...
        <FadeIn delay={0.25}>
          <p className="font-mono text-xs sm:text-sm text-muted leading-[1.9] max-w-[80%]">
            ¿Tienes una idea, un proyecto o simplemente quieres hablar de diseño
            y desarrollo? Estoy abierta a nuevas colaboraciones, desafíos
            interesantes y conversaciones sobre cómo mejorar la experiencia digital.
          </p>
        </FadeIn>
          ...
          >
            <button className="group relative mt-8 font-mono text-[11px] tracking-[3px] uppercase
              ...
              <span className="relative z-10 flex items-center gap-2">
                ¡Conectemos! <span className="group-hover:translate-x-1 inline-block transition-transform">↗</span>
              </span>
